...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Krish Vamsi
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className='home__description'> As a Senior Software Engineer, I leverage my expertise in backend development, front-end customization, and automation to create scalable solutions for seamless data processing. </p>
...
>
  <path
    ...
    fill="currentColor" /* Use currentColor instead of var(container-color) */
  ></path>
  <path
